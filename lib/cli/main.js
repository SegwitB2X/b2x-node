...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `b2x-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ b2x-node add wallet-service');
      console.log('    $ b2x-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ b2x-node remove wallet-service');
      console.log('    $ b2x-node remove insight-api');
      console.log();
    });
