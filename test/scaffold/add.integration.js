...
describe('#add', function() {
  ...
  describe('will modify scaffold files', function() {
    ...
    it('will update b2x-node.json services', function(done) {
      var callCount = 0;
      var oldPackage = {
        dependencies: {
          'b2x-core-lib': '^v0.13.7',
          'b2x-node': '^v0.2.0'
        }
      };
      var spawn = sinon.stub().returns({
      ...
      addtest({
        ...
        var configPath = path.resolve(testDir, 's0/s1/b2x-node.json');
